...
import dev.malangkey.app.settings.theme.ColorPreferenceSerializer
import dev.malangkey.app.settings.theme.DisplayKbdAfterDialogs
import dev.malangkey.app.settings.theme.SnyggLevel
import dev.malangkey.app.setup.NotificationPermissionState
...
import dev.malangkey.ime.smartbar.quickaction.QuickActionArrangement
import dev.malangkey.ime.smartbar.quickaction.QuickActionJsonConfig
...
import dev.malangkey.ime.theme.extCoreTheme
import dev.malangkey.ime.window.ImeWindowConfig
import dev.malangkey.lib.ext.ExtensionComponentName
import dev.malangkey.lib.util.VersionName
...
abstract class FlorisPreferenceModel : PreferenceModel() {
    ...
    inner class Clipboard {
        ...
        val quickPhraseTriggerKey = enum(
            ...
            default = dev.malangkey.ime.clipboard.QuickPhraseTriggerKey.PERIOD,
        )
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    dev.malangkey.ime.media.emoji.Emoji(it, "", emptyList())
                }
