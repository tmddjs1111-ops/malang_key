...
import dev.malangkey.ime.popup.MutablePopupSet
import dev.malangkey.ime.popup.PopupMapping
import dev.malangkey.ime.popup.PopupSet
        ...
        if (evaluator.keyboard.mode == KeyboardMode.GRID_16KEY || evaluator.keyboard.mode == KeyboardMode.CHARACTERS) {
            if (computedNumberHint == null) {
                val hintCode = if (evaluator.keyboard.mode == KeyboardMode.GRID_16KEY) {
                    ...
                    when (keyCode) {
                        113, 81, 12610 -> 49 // ㅂ, ㅃ, q, Q -> 1
                        119, 87, 12616 -> 50 // ㅈ, ㅉ, w, W -> 2
                        101, 69, 12599 -> 51 // ㄷ, ㄸ, e, E -> 3
                        114, 82, 12593 -> 52 // ㄱ, ㄲ, r, R -> 4
                        116, 84, 12613 -> 53 // ㅅ, ㅆ, t, T -> 5
                        121, 89, 12635 -> 54 // ㅛ, y, Y -> 6
                        117, 85, 12629 -> 55 // ㅕ, u, U -> 7
                        105, 73, 12625 -> 56 // ㅑ, i, I -> 8
                        111, 79, 12624 -> 57 // ㅐ, ㅒ, o, O -> 9
                        112, 80, 12626 -> 48 // ㅔ, ㅖ, p, P -> 0
                        else -> null
                    }
                }
                if (hintCode != null) {
