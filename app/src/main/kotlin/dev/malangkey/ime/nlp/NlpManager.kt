...
import dev.malangkey.ime.media.emoji.EmojiSuggestionProvider
...
class NlpManager(context: Context) {
    ...
    private val providers = guardedByLock {
        mapOf(
            ...
            dev.malangkey.ime.nlp.japanese.JapaneseLanguageProvider.ProviderId to ProviderInstanceWrapper(dev.malangkey.ime.nlp.japanese.JapaneseLanguageProvider(context)),
        )
    }
