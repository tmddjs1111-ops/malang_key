...
package dev.malangkey.benchmark
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        ...
        setupBlock = {
            pressHome()
            device.executeShellCommand("ime enable dev.malangkey/.FlorisImeService")
            device.executeShellCommand("ime set dev.malangkey/.FlorisImeService")
        }
    ) {
