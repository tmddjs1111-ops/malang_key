...
package dev.malangkey.ime.keyboard
...
import dev.malangkey.ime.editor.FlorisEditorInfo
import dev.malangkey.ime.editor.ImeOptions
import dev.malangkey.ime.editor.InputAttributes
import dev.malangkey.ime.editor.OperationUnit
import dev.malangkey.ime.input.CapitalizationBehavior
import dev.malangkey.ime.input.InputEventDispatcher
import dev.malangkey.ime.input.InputKeyEventReceiver
import dev.malangkey.ime.input.InputShiftState
import dev.malangkey.ime.nlp.ClipboardSuggestionCandidate
import dev.malangkey.ime.nlp.PunctuationRule
import dev.malangkey.ime.nlp.SuggestionCandidate
import dev.malangkey.ime.popup.PopupMappingComponent
import dev.malangkey.ime.text.composing.Composer
...
import dev.malangkey.lib.titlecase
import dev.malangkey.lib.uppercase
...
class KeyboardManager(context: Context) : InputKeyEventReceiver {
    ...
    fun commitCandidate(candidate: SuggestionCandidate) {
        ...
        when (candidate) {
            ...
            is dev.malangkey.ime.nlp.ReplaceWordSuggestionCandidate -> {
                editorInstance.setSelectionSurrounding(candidate.originalWordLength, dev.malangkey.ime.editor.OperationUnit.CHARACTERS, dev.malangkey.ime.editor.OperationScope.BEFORE_CURSOR)
